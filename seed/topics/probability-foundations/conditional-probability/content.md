...
plt.plot(cumulative_switch, color='#14b8a6', label='Switch strategy', linewidth=1.5)
plt.plot(cumulative_stay, color='#71717a', label='Stay strategy', linewidth=1.5)
plt.axhline(y=2/3, color='#14b8a6', linestyle='--', alpha=0.4)
plt.axhline(y=1/3, color='#71717a', linestyle='--', alpha=0.4)
