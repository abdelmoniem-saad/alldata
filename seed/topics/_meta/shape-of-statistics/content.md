...
You'll start here because every later concept points back to it.
...
Confidence intervals. Hypothesis tests. p-values. Maximum likelihood. Bayesian posteriors. They're all the same shape underneath: *here's a procedure that, given my assumptions, lets me make a calibrated claim.*

Most of statistics' bad reputation comes from people doing inference without knowing they're doing inference. This cluster is where you fix that.
...
This cluster is small because most of what makes a good practitioner is *judgment*, and judgment shows up in how you apply the other clusters. The practice nodes are the ones that catch the things the math doesn't.
